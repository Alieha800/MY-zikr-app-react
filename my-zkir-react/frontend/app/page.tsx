...
export default function Home() {
  ...
  const authenticDuaCategories = [
    { id: 'tout', icon: '/Tout.png', isImage: true, name: 'Tout', chapters: '132 chapitres' },
    { id: 'matin-soir', icon: '/Matin and soir.png', isImage: true, name: 'Matin & Soir', chapters: '15 chapitres' },
    { id: 'maison-famille', icon: '/masine and famillie.png', isImage: true, name: 'Maison & Famille', chapters: '12 chapitres' },
    { id: 'manger-jeune', icon: '/fork.png', isImage: true, name: 'Manger & Jeûne', chapters: '7 chapitres' },
    { id: 'joie-detresse', icon: '/conatiner.png', isImage: true, name: 'Joie & Détresse', chapters: '15 chapitres' },
    { id: 'voyage', icon: '/voyage.png', isImage: true, name: 'Voyage', chapters: '6 chapitres' },
    { id: 'priere', icon: '/dua image.png', isImage: true, name: 'Prière', chapters: '19 chapitres' },
    { id: 'invocation', icon: '/prayer.png', isImage: true, name: 'Invocation', chapters: '8 chapitres' },
    { id: 'haji-omra', icon: '/kaba image.png', isImage: true, name: 'Haji & Omra', chapters: '8 chapitres' },
    { id: 'bonnes-regles', icon: '/shaking hand.png', isImage: true, name: 'Bonnes règles', chapters: '20 chapitres' },
    { id: 'nature', icon: '/tree image.png', isImage: true, name: 'Nature', chapters: '10 chapitres' },
    { id: 'maladie-mort', icon: '/emojis.png', isImage: true, name: 'Maladie & Mort', chapters: '9 chapitres' }
  ];
    ...
    <div className="h-screen bg-gradient-to-br from-emerald-900 via-slate-900 to-slate-950 flex flex-col overflow-hidden">
      {!validateNavigationState() ? (
        ...
        <div className="flex-1 flex flex-col h-screen w-full max-w-none overflow-hidden">
          ...
          <div className="text-center mb-12">
            ...
            <div className="mb-4 flex justify-center">
              <img src="my-zikr-logo.png" alt="My.Zikr Logo" className="w-40 md:w-48 h-40 md:h-48 object-contain" style={{ filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.3))' }} />
            </div>
        ...
        <div className="flex-1 flex flex-col h-screen w-full max-w-none overflow-hidden">
          ...
          <div className="flex items-center px-4 sm:px-6 py-4 sm:py-6 pt-8 sm:pt-6 relative">
            {/* Leaves Icon - Sidebar Menu - Mobile Responsive */}
            <button
              onClick={() => setShowDiscussMenu(true)}
              className="hover:scale-110 transition-transform absolute left-4 sm:left-6"
            >
            ...
            {/* Logo/App Name - Mobile Responsive - Icon Style - Perfectly Centered */}
            ...
            {/* Notifications/Reminder - Mobile Responsive - Right aligned */}
            <div className="flex items-center space-x-1 sm:space-x-2 absolute right-4 sm:right-6">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <h1 className="text-xl sm:text-2xl text-white font-bold mb-4 sm:mb-6 text-center">
              Salam Aleykoum {userName || 'Adnan'}!
            </h1>

            {/* Dua of the day Section - Mobile Responsive */}
            <div className="mb-4 sm:mb-6">
              <h2 className="text-white text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-center">Dua of the day</h2>

              {/* Dua Card */}
              <div className="bg-cream rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6">
                {/* Arabic Calligraphy */}
                <div className="text-center mb-3 sm:mb-4">
                  <div className="text-xl sm:text-2xl text-gray-900 font-arabic leading-relaxed">
                ...
                <div className="flex justify-center space-x-4 sm:space-x-6">
                  <button className="text-gray-900 text-lg sm:text-xl hover:text-gray-700 transition-colors">
                    🔊
                  </button>
                  <button className="text-gray-900 text-lg sm:text-xl hover:text-gray-700 transition-colors">
                    ❤️
              ...
              <div className="mb-6 sm:mb-8 text-center">
                ...
                <div className="mb-4 sm:mb-6 flex justify-center">
                  <div className="bg-white rounded-full p-2 sm:p-3 shadow-lg">
                    <img src="my-zikr-logo.png" alt="My.Zikr Logo" className="w-24 sm:w-28 h-24 sm:h-28 object-contain" />
                  </div>
                </div>
        ...
        <div className="h-screen bg-gradient-to-b from-[#0D3B2E] to-[#0B1E3A] flex flex-col animate-fadeIn overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {/* Dua Categories Grid - Exact Layout to Match Screenshot */}
            <div className="mb-4 sm:mb-6">
              {/* First Row - 3 buttons: Anxiety, Sadness, To protect kids */}
              <div className="grid grid-cols-3 gap-2 mb-2">
                <button
                  onClick={() => handleToProtectKidsCategorySelect('Anxiety')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'Anxiety'
                ...
                <button
                  onClick={() => handleToProtectKidsCategorySelect('Sadness')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'Sadness'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
                ...
                <button
                  onClick={() => handleToProtectKidsCategorySelect('To protect kids')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
              ...
              {/* Second Row - 2 buttons: When entering home, For forgiveness */}
              <div className="grid grid-cols-2 gap-2 mb-2 max-w-md mx-auto">
                <button
                  onClick={() => handleToProtectKidsCategorySelect('When entering home')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'When entering home'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
                ...
                <button
                  onClick={() => handleToProtectKidsCategorySelect('For forgiveness')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'For forgiveness'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
              ...
              {/* Third Row - 2 buttons: For guidance, When entering Toilet */}
              <div className="grid grid-cols-2 gap-2 mb-2 max-w-md mx-auto">
                <button
                  onClick={() => handleToProtectKidsCategorySelect('For guidance')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'For guidance'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
                ...
                <button
                  onClick={() => handleToProtectKidsCategorySelect('When entering Toilet')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'When entering Toilet'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
              ...
              {/* Fourth Row - 2 buttons: Morning and evening duas, For sickness */}
              <div className="grid grid-cols-2 gap-2 mb-2 max-w-md mx-auto">
                <button
                  onClick={() => handleToProtectKidsCategorySelect('Morning and evening duas')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'Morning and evening duas'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
                ...
                <button
                  onClick={() => handleToProtectKidsCategorySelect('For sickness')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'For sickness'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
              ...
              {/* Fifth Row - 2 buttons: When waking up at night, Another one */}
              <div className="grid grid-cols-2 gap-2 max-w-md mx-auto">
                <button
                  onClick={() => handleToProtectKidsCategorySelect('When waking up at night')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'When waking up at night'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
                ...
                <button
                  onClick={() => handleToProtectKidsCategorySelect('Another one')}
                  className={`px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 ${
                    selectedDuaCategory === 'Another one'
                      ? 'bg-[#1E3A8A] text-white'
                      : 'bg-[#F5F0E6] text-[#0B1E3A] hover:bg-[#E5DDD3]'
                  }`}
                >
        ...
        /* Screen 5: Static Welcome Page - Non-interactive */
        <div className="relative h-screen bg-gradient-to-b from-[#0D3B2E] to-[#0B1E3A] flex flex-col overflow-hidden">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="relative">
              ...
              <div className="mb-3 sm:mb-4 flex justify-center">
                <img src="my-zikr-logo.png" alt="My.Zikr Logo" className="w-32 sm:w-36 md:w-40 h-32 sm:h-36 md:h-40 object-contain" style={{ filter: 'drop-shadow(0 3px 6px rgba(0, 0, 0, 0.25))' }} />
              </div>
            </div>
          </div>

          {/* Static Welcome Message - No Interactive Elements */}
          <div className="w-full max-w-xs sm:max-w-lg mb-6 sm:mb-8">
            <div className="relative">
              {/* Static Chat Bubble - Mobile Responsive */}
              <div className="bg-[#1A5A4F] rounded-[20px] sm:rounded-[24px] p-4 sm:p-6 text-white shadow-xl animate-fadeIn relative">
                <p className="text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed font-normal">
                  <span className="font-medium">Welcome to My.Zikr</span><br/><br/>
                  Discover authentic duas, spiritual reminders, and connect with the Muslim community. Take your time to explore our collection of prayers and find peace in your daily worship.<br/><br/>
                  This is a static welcome page designed to introduce you to the beauty of Islamic prayers and remembrance.
                </p>
          ...
          {/* Static Information Cards - Mobile Responsive */}
          <div className="w-full max-w-xs sm:max-w-lg space-y-3 sm:space-y-4 mb-6 sm:mb-8">
            {/* Feature 1 - Static Information */}
            <div className="bg-[#0F3D34] text-[#FFD700] py-3 sm:py-4 px-4 sm:px-6 rounded-full flex items-center space-x-3 sm:space-x-4">
              <span className="text-base sm:text-lg text-[#FFD700]">🤲</span>
              <span className="flex-1 text-left font-medium text-sm sm:text-base">Authentic Duas Collection</span>
            </div>

            {/* Feature 2 - Static Information */}
            <div className="bg-[#1A1A4A] text-[#87CEEB] py-3 sm:py-4 px-4 sm:px-6 rounded-full flex items-center space-x-3 sm:space-x-4">
              <span className="text-base sm:text-lg text-[#87CEEB]">🕌</span>
              <span className="flex-1 text-left font-medium text-sm sm:text-base">Prayer Reminders</span>
            </div>

            {/* Feature 3 - Static Information */}
            <div className="bg-[#F5F0E6] text-[#8B4513] py-3 sm:py-4 px-4 sm:px-6 rounded-full flex items-center space-x-3 sm:space-x-4 border border-[#E5DDD3]">
              <span className="text-base sm:text-lg text-[#8B4513]">📖</span>
              <span className="flex-1 text-left font-medium text-sm sm:text-base">Islamic Knowledge</span>
            </div>
          </div>

          {/* Static Continue Button - Mobile Responsive - Moved Up */}
          <div className="w-full max-w-xs sm:max-w-lg mt-8 sm:mt-12">
            <button
              onClick={() => navigateToScreen('home')}
              className="w-full bg-[#F5F0E6] text-[#0B1E3A] font-semibold py-3 sm:py-4 px-8 sm:px-12 rounded-full text-base sm:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Continue to App
            </button>
          </div>
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-8 animate-fadeIn">
          ...
          <div className="text-center mb-20" style={{ paddingTop: '80px' }}>
            {/* Logo Image */}
            <div className="mb-4 flex justify-center">
              <img src="my-zikr-logo.png" alt="My.Zikr Logo" className="w-36 md:w-40 h-36 md:h-40 object-contain" style={{ filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.3))' }} />
            </div>
          ...
          <div className="relative z-10 flex flex-col items-center justify-center max-w-md mx-auto text-center">
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <div className="flex items-center justify-center mb-4">
                <img src="my-zikr-logo.png" alt="My.Zikr Logo" className="w-32 sm:w-36 h-32 sm:h-36 object-contain" style={{ filter: 'drop-shadow(0 3px 6px rgba(0, 0, 0, 0.25))' }} />
              </div>
            </div>
        ...
        <div className="relative flex flex-col h-screen overflow-hidden">
          ...
          <div className="text-center mb-8 sm:mb-12 mt-16 sm:mt-20">
            {/* Logo Image */}
            <div className="mb-3 sm:mb-4 flex justify-center">
              <img src="my-zikr-logo.png" alt="My.Zikr Logo" className="w-36 sm:w-40 md:w-44 h-36 sm:h-40 md:h-44 object-contain" style={{ filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.3))' }} />
            </div>
          </div>
          ...
          {/* Navigation Button Section - Updated Layout to Match Second Design */}
          <div className="w-full max-w-lg mb-8 sm:mb-10">
            {/* Line 1 - Horizontal Pair: Authentic dua and Custom dua */}
            <div className="flex gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              >
                <span className="text-lg sm:text-xl">🪔</span>
                <span className="text-xs sm:text-sm font-medium mt-1">Custom dua for my situation</span>
              </button>
            </div>

            {/* Line 2 - Centered Single Button: Spiritual reminder */}
            <div className="flex justify-center">
              <button
                onClick={() => {
                  setShowWelcomeScreen(false);
        ...
        <div className="flex-1 flex flex-col h-screen w-full max-w-none overflow-hidden">
          ...
          {/* Category Grid (Main Content) - Scrollable - Mobile Responsive */}
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-6 max-w-4xl mx-auto">
              {authenticDuaCategories.map((category) => (
                <button
                  ...
                  className="flex flex-col items-center space-y-2 sm:space-y-3 p-2 sm:p-4 rounded-xl border-0 bg-transparent"
                >
                  {/* Circular Icon */}
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-black rounded-full flex items-center justify-center flex-shrink-0">
                    {category.isImage ? (
                      <img src={category.icon} alt={category.name} className="w-9 h-9 sm:w-12 sm:h-12 object-contain" />
                    ) : (
                  ...
                  {/* Category Name */}
                  <span className="text-white text-xs sm:text-sm font-medium text-center line-clamp-2 whitespace-normal">
                    {category.name}
                  </span>

                  {/* Chapter Count */}
                  <span className="text-white text-xs opacity-75 text-center whitespace-nowrap">
                    {category.chapters}
                  </span>
                </button>
              ))}
        ...
        <div className="flex-1 flex flex-col h-screen w-full max-w-none bg-gradient-to-b from-[#0D4F4F] to-[#1E3A8A] overflow-hidden">
          ...
          {/* Bottom Navigation Bar - Fixed on Mobile Only */}
          <div className="fixed md:static bottom-0 left-0 right-0 bg-[#1E3A8A] bg-opacity-80 px-6 py-4 md:relative">
        ...
        <div className="flex-1 flex flex-col h-screen w-full max-w-none overflow-hidden">
          ...
          {/* Chat Message (Bot's Response) - Enhanced */}
          <div className="w-full max-w-4xl mx-auto mb-8 px-6">
            <div className="flex items-start space-x-3">
              <div className="bg-emerald-600 rounded-full p-2 flex-shrink-0 shadow-md">
                <span className="text-white text-xs font-bold">Z</span>
              </div>
              <div className="bg-emerald-800/90 rounded-2xl rounded-tl-sm p-5 sm:p-6 max-w-2xl shadow-lg backdrop-blur-sm">
                <p className="text-white text-base leading-relaxed">
          ...
          {/* Action Pills (Quick Links) - Updated Layout */}
          <div className="w-full max-w-4xl mx-auto px-6 mb-8">
            <div className="space-y-3">
              {/* Row 1 (2 pills) */}
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="bg-cream text-gray-900 px-4 py-3 rounded-full text-sm font-medium hover:bg-gray-100 transition-colors text-center shadow-sm"
                >
                  See my saved duas
                </button>
                <button
              ...
              {/* Row 3 (1 pill) - Centered */}
              <div className="flex justify-center">
                <button
                  onClick={() => handleQuickAction('See the whole reminders collection')}
                  className="bg-cream text-gray-900 px-6 py-3 rounded-full text-sm font-medium hover:bg-gray-100 transition-colors text-center shadow-sm w-full max-w-xs"
                >
          ...
          {/* Text Input Area (User Prompt) - Enhanced styling */}
          <div className="w-full max-w-4xl mx-auto px-6 pb-8 mt-auto">
            <div className="relative">
              <textarea
                ...
                placeholder="Write down what you need like I need help to ..."
                className="w-full h-20 sm:h-24 bg-slate-800 text-white placeholder-gray-400 rounded-2xl p-4 sm:p-5 pr-12 sm:pr-14 border border-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 resize-none text-sm sm:text-base shadow-lg"
                onKeyPress={(e) => {
              ...
              <button
                ...
                className="absolute bottom-3 right-3 bg-emerald-600 hover:bg-emerald-700 text-white p-2 rounded-full transition-all duration-200 hover:scale-105 shadow-md"
              >
      ...
      {showDiscussMenu && (
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          {/* Menu Container - Compact design matching reference - Mobile Responsive */}
          <div className="absolute top-16 left-4 right-4 sm:left-8 sm:right-auto z-50">
            <div className="bg-[#F5F5DC] rounded-xl shadow-2xl p-2 sm:p-3 w-full sm:w-48 md:w-52">
              ...
              <div className="space-y-1">
                {menuItems.map((item) => (
                  <button
                    ...
                    className={`w-full flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-lg transition-colors text-left whitespace-nowrap overflow-hidden text-ellipsis ${
              ...
              <div className="border-t border-gray-200 pt-2 mt-2">
                <button
                  ...
                  className="w-full flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors text-left whitespace-nowrap overflow-hidden text-ellipsis"
                >
                  <div className="flex items-center space-x-1 flex-shrink-0">
                    <span className="text-lg text-gray-400">💎</span>
                    <span className="text-lg text-gray-400">🔒</span>
                  </div>
                  <span className="font-medium text-xs sm:text-sm text-gray-900 flex-1 truncate">My.Zikr+</span>
                </button>
              </div>
            </div>
          </div>
